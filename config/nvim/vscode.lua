...
km('n', ']g', cmd('editor.action.marker.next'))
km('n', '[g', cmd('editor.action.marker.prev'))
km('n', '[G', cmd('editor.action.marker.nextInFiles'))
km('n', ']G', cmd('editor.action.marker.prevInFiles'))
km('n', ']d', cmd('editor.debug.action.goToNextBreakpoint'))
km('n', '[d', cmd('editor.debug.action.goToPreviousBreakpoint'))
