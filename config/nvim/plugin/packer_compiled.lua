...
_G.packer_plugins = {
  ...
  coq_nvim = {
    loaded = true,
    path = "/home/brian/.local/share/nvim/site/pack/packer/start/coq_nvim"
  },
  firenvim = {
    loaded = true,
  ...
  ["vim-racket"] = {
    loaded = true,
    path = "/home/brian/.local/share/nvim/site/pack/packer/start/vim-racket"
  },
  ["vim-repeat"] = {
    loaded = true,
...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file Goyo lua require("packer.load")({'limelight.vim', 'goyo.vim'}, { cmd = "Goyo", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args> }, _G.packer_plugins)]])
...
time([[Sourcing ftdetect script at: /home/brian/.local/share/nvim/site/pack/packer/opt/vimtex/ftdetect/cls.vim]], true)
vim.cmd [[source /home/brian/.local/share/nvim/site/pack/packer/opt/vimtex/ftdetect/cls.vim]]
time([[Sourcing ftdetect script at: /home/brian/.local/share/nvim/site/pack/packer/opt/vimtex/ftdetect/cls.vim]], false)
...
time([[Sourcing ftdetect script at: /home/brian/.local/share/nvim/site/pack/packer/opt/vimtex/ftdetect/tikz.vim]], true)
vim.cmd [[source /home/brian/.local/share/nvim/site/pack/packer/opt/vimtex/ftdetect/tikz.vim]]
time([[Sourcing ftdetect script at: /home/brian/.local/share/nvim/site/pack/packer/opt/vimtex/ftdetect/tikz.vim]], false)
vim.cmd("augroup END")
